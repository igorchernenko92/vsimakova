...
//      hash: false,
    ...
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/inter.pug`,
      filename: './inter.html'
    }),          
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/founder.pug`,
      filename: './founder.html'
    }),               
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/english.pug`,
      filename: './english.html'
    }),            
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/profit.pug`,
      filename: './profit.html'
    }),            
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/feedback.pug`,
      filename: './feedback.html'
    }),                      
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/howtochange.pug`,
      filename: './howtochange.html'
    }),                    
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/pblschool.pug`,
      filename: './pblschool.html'
    }),                        
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/research.pug`,
    ...
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/contact.pug`,
