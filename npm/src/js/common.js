...
//  $('header').addClass('open');
   ...
   $('.lang__link').click(function() {
     ...
     $('.lang>.lang__menu').toggleClass('active');
...
// ===========================================================    
    ...
    var $slider__home = $('.slider__home');
      ...
      $slider__home.slick({
        ...
        $slider__home.on('init', function(event, slick){
          slideCount = slick.slideCount;
          setSlideCount();
          setCurrentSlideNumber(slick.currentSlide);
      });

      $slider__home.on('beforeChange', function(event, slick, currentSlide, nextSlide){
...
// ===========================================================    
  ...
  $('.next__.top').click(function() { 
    $inter__slider__top__.slick('slickNext');
  });
 
  $('a.prev__.top').click(function() {
    $inter__slider__top__.slick('slickPrev');
  });

  var $inter__slider__top__ = $('.slider__top');
  
  
    $inter__slider__top__.slick({
...
//        ]
  ...
  $('a.next__.bottom').click(function() { 
    $inter__2_slider__.slick('slickNext');
  });
 
  $('a.prev__.bottom').click(function() {
    $inter__2_slider__.slick('slickPrev');
  });

  var $inter__2_slider__ = $('.slider__bottom');
  
  
    $inter__2_slider__.slick({
