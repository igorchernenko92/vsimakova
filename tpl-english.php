...
get_header(); ?>
    ...
    if( have_rows('english_pages') ):
         // loop through the rows of data
        while ( have_rows('english_pages') ) : the_row(); ?>
        <?php if( get_row_layout() == 'section_1' ): ?>
    
    <section class="english__1">
      <div class="container">
        <div class="row">
  ...
  <?php endif; ?>
            ...
            <a class="scroll__" href="#english__2"><img src="<?= get_template_directory_uri(); ?>/img/str.svg" alt="search"></a>
          </div>
        </div>
        <div class="row">
          <div class="col m12 s12 l12 xl12">
...
<?php endif; ?>  
          ...
          <div class="col m12 s12 l12 xl12">
            <div class="slid__arrow"><a class="prev__ top" href="javascript:;">
              ...
              </a><a class="next__ top" href="javascript:;">
...
<?php endif; ?>  
  ...
  <?php endif; ?>
    ...
    <section class="english__2" id="english__2">
      <div class="container">
        <div class="row">
          <div class="col m12 s12 l12 xl12">
   <?php if( get_sub_field('content')): ?><!-- if under__the -->
